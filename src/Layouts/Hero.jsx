    ...
    <section className="max-w-[1320px] px-4 md:px-0 mx-auto my-12 md:my-32">
      <div className="flex  justify-between flex-col items-start md:gap-0 gap-y-12">
        <div className="flex flex-col gap-y-7.5">
          ...
          <Pera
            text="Our user-friendly platform enables businesses and individuals to seamlessly convert and spend their crypto for everyday purchases."
            className=" text-sm md:text-[18px] md:leading-6 md:w-[498px] flex-wrap"
          />
