    ...
    <section className="max-w-330 mx-auto mt-16 mb-16 md:mt-36 md:mb-42 px-4 md:px-0">
      <div className="flex flex-col md:flex-row gap-y-10 md:justify-between items-center">
        <div className="flex flex-col gap-y-7.5">
          ...
          <Pera
            text="More than just a card, it's a bridge to a new financial experience. Embrace the simplicity and security of spending your Cardano with the Wern Card."
            className="text-sm md:text-[16px] md:leading-6 md:w-[424px]"
          />
          ...
          <div className="flex flex-col gap-y-1">
            ...
            <p className="text-[14px] font-bold text-primary ml-10">
