...
function Cards({ des, src, name, status }) {
  return (
    <div className="w-full md:w-[392px] rounded-[32px] bg-[#27322F]/24 backdrop-blur px-3 md:px-6 md:py-12 py-6">
      <div className="flex flex-col gap-y-8">
        ...
        <p className="text-[16px] font-poppins md:w-[344px] w-full flex-wrap text-white leading-6">
          {des}
        </p>
        ...
        <div className="flex items-center gap-x-2">
          ...
          <div className="flex flex-col gap-x-1">
            <h5 className="font-medium text-[16px] text-white tracking-[-0.32px]">
              {name}
            </h5>
